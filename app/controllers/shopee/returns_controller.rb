...
module Shopee
  class ReturnsController < ApplicationController
    def import
      ...
      raise ArgumentError, "only .xls and .xlsx are supported" unless %w[.xls .xlsx].include?(ext)

      tmp_dir = Rails.root.join("tmp", "uploads", "shopee_returns")
      ...
      result = ::Shopee::ImportReturns.call!(
        shop: shop,
      ...
      render json: {
        ...
        grouped_returns: result[:grouped_returns],
      ...
      Rails.logger.error(
        {
          event: "shopee.returns.import.fail",
